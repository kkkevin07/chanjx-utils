...
public abstract class HttpClientUtils {
    ...
    public static HttpResponse doPostMultipartForm(String uri, HttpFile httpFile, Map<String, String> params) {
        return doPostMultipartForm(uri, httpFile, params, null);
    }

    public static HttpResponse doPostMultipartForm(String uri, HttpFile httpFile, Map<String, String> params, Map<String, String> headers) {
    ...
    public static HttpResponse doPostMultipartForm(String uri, HttpFiles httpFiles, Map<String, String> params) {
        return doPostMultipartForm(uri, httpFiles, params, null);
    }

    public static HttpResponse doPostMultipartForm(String uri, HttpFiles httpFiles, Map<String, String> params, Map<String, String> headers) {
    ...
    public static HttpResponse doPostMultipartForm(String uri, List<HttpFile> httpFiles, Map<String, String> params) {
        return doPostMultipartForm(uri, httpFiles, params, null);
    }

    public static HttpResponse doPostMultipartForm(String uri, List<HttpFile> httpFiles, Map<String, String> params, Map<String, String> headers) {
        final MultipartEntityBuilder builder = MultipartEntityBuilder.create();
    ...
    public static HttpResponse doPostMultipartForm(String uri, HttpFiles httpFiles, List<HttpFile> httpFileList, Map<String, String> params) {
        return doPostMultipartForm(uri, httpFiles, httpFileList, params, null);
    }

    public static HttpResponse doPostMultipartForm(String uri, HttpFiles httpFiles, List<HttpFile> httpFileList, Map<String, String> params, Map<String, String> headers) {
        final MultipartEntityBuilder builder = MultipartEntityBuilder.create();
    ...
    private static HttpResponse sendForm(Map<String, String> params, Map<String, String> headers, HttpUriRequestBase method) {
     ...
     * @return 请求字符串结果
     */
    private static HttpResponse send(HttpUriRequestBase request, Map<String, String> headers) {
